import os
import gdown  # Bu satır şart

# --- Model dosyalarını Drive'dan indir ---
model_folder = "models"
os.makedirs(model_folder, exist_ok=True)

vehicle_model_path = os.path.join(model_folder, "best_vehicle.pt")
lane_model_path = os.path.join(model_folder, "best_lane.pt")

# Sadece dosya yoksa indir
if not os.path.exists(vehicle_model_path):
    gdown.download("https://drive.google.com/uc?id=1kzDDSf-eJnoMoXJkW5dHh_00R4vGKI25", vehicle_model_path, quiet=False)

if not os.path.exists(lane_model_path):
    gdown.download("https://drive.google.com/uc?id=1m1976oNttHTkxa421HL38Kabj82SAbwk", lane_model_path, quiet=False)
